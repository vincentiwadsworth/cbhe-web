...
Este curso es interactivo, utiliza un enfoque práctico que le enseña a los estudiantes a inspeccionar, probar, aceptar y mantener sistemas de protección contra incendios a base de agua. Obtenga estos conocimientos a través de una conferencia altamente técnica unida a ejercicios prácticos para así evitar errores e incrementar la eficacia de estos sistemas de protección contra incendios.

## Dirigido a

Técnicos y profesionales que trabajan en áreas relacionadas a la inspección, prueba y mantenimiento de sistemas de agua. Técnicos y profesionales encargados del diseño, mantenimiento, contratistas de sistemas de rociadores, control y seguridad de sistemas contra incendios.

## Temario

- Alcance de la norma de IPM
- Definiciones
- Responsabilidades
- Registros y protocolos de IPM
- Sistemas de rociadores automáticos
- Bombas contra incendios
- Redes contra incendios
- Sistemas de abastecimiento de agua
- Hidrantes de incendios
- Sistemas de rociadores agua-espuma
- Sistemas de agua pulverizada
- Sistemas de columnas de agua y mangueras
...
- **Fechas**: 14, 15, 16 y 17 de julio de 2026
